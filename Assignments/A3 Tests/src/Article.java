public class Article {
     ...
     * @param authors String representing the list made of the names of the authors (taken directly from the file and
     *                contains "and").
     * @return String representing the list made of the names of the author as required by the format of the reference
     */
    public String generateAuthorFormat(String format, String authors){
        String authorList = "";
        int oldIndex = 0;
    ...
    public String generateIEEE(){
        return generateAuthorFormat("IEEE", authors) + " \"" + title + "\", " + journal + ", vol. " + volume + ", no. " +
    ...
    public String generateACM(){
        return generateAuthorFormat("ACM", authors) + " " + year + ". " + title + ". " + journal + ". "+ volume + ", " + number + " (" + year + "), " + pages + ". DOI:https://doi.org/" + doi + ".";
    }
    ...
    public String generateNJ(){
        return generateAuthorFormat("NJ", authors) + " " + title + ". " + journal + ". " + volume + ", " + pages + "(" + year + ").";
    }
